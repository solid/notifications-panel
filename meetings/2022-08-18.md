...
* AC: Just because websockets has a mechanism it doesn't mean it is supported in ??? the notifications protocol is trying to be generic. in order to be generic we can't specify / customise for each.
