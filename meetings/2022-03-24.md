...
* TT: Don't. Registry management is itself a large project. W3C hasn't figured it out yet. IANA sort of handles it okay. There are time questions always. How to handle offensive terminology etc. Registries is appealing but there is an awful lot disclaimer associated to it.
* AC: Adding as much disclaimer about that is a good thing to be aware of. Also, between now and creating a full version -- what we have produced doesn't step on those landlines.
