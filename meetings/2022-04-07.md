...
* AC: Snapshot is from April 1st, if they are changes that are suggested, any of those changes should go back into underlying specification, they should be opened as issues and resolved via PR. Than they would be another snapshot let's say April 17th. If there are blocking reviews on April 1st it would be closed and not merged.
